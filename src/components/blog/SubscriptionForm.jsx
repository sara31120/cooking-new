    ...
    <section className="bg-white py-12">
      <div className="max-w-4xl mx-auto text-center relative">
        <div className="relative">
          ...
          />
          <div className="absolute top-3/4 transform -translate-y-1/2 left-1/2 -translate-x-1/2 flex flex-col justify-center items-center space-y-6 bg-customBlue shadow-lg rounded-xl p-6">
            <div className="flex">
              <input
                type="email"
